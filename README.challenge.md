...
You can also inspect the generated API reference at `/docs`, `/docs/swagger`, `/openapi.json`, or `/openapi.yaml`, where both workflow endpoints are documented with their success and error responses.
